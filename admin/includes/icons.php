...
function tt_admin_icon(string $id): string
{
    $paths = [
        ...
        'section-headings' => '<path d="M4 6h16M4 12h16M4 18h10"/>',
        ...
        'backup' => '<path d="M21 16V8a2 2 0 0 0-1-1.73L12 2 4 6.27A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73L12 22l8-4.27A2 2 0 0 0 21 16z"/><path d="M12 22V12"/><path d="m3.3 7 8.7 5 8.7-5"/>',
