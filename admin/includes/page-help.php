...
function tt_admin_page_help_map(): array
{
    return [
        ...
        'boats' => [
            'lead' => 'ประเภทเรือ — หัวข้อหน้าแรก + หน้า boats.html + การ์ด',
            'items' => [
                'หัวข้อใหญ่บนหน้าแรก (ประเภทเรือ / เลือกเรือให้เหมาะ…) — แก้ที่ฟอร์มด้านบนหน้านี้',
                'หน้า 「ประเภทเรือ」 — รายละเอียดเรือแต่ละแบบ',
                'การ์ดเรือในหน้าแรก — แก้รายการเรือด้านล่างตาราง',
            ],
            'preview' => '../boats.html',
            'visuals' => [
                [
